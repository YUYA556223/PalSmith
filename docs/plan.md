...
| V3 | 配置物イベント(onPlace/onInteract)のフック特定([poc/V3-place-interact-hooks](../poc/V3-place-interact-hooks)) | 建物系Behaviorの成立性 | ✅ **成功(2026-07-16)** 3/3発火。BuildObjectId直読み。**C4完全成立** |
| V4 | 最小WBPをcook→pakロード→Luaから開閉+クリック往復([poc/V4-ui](../poc/V4-ui)) | UIフレームワーク(④)の土台 | プレイブック+F11プローブ配置済。UE5セットアップ(Part A/B)待ち |
