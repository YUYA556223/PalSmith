...
> 📗 **英語版の詳細ガイド**: [`docs/pmk-setup.md`](../../docs/pmk-setup.md)(クリック手順・トラブルシュート込み)
>
> 🚀 **自動化スクリプトあり**: [`tools/setup-pmk.ps1`](../../tools/setup-pmk.ps1) が
> VS2022/.NET6/Git/Epicランチャーのインストール、PMKクローン、BuildConfiguration設定、
> そして一番ミスりやすい**Wwise手動統合(コピー+パッチ)を全自動**で行う。
> 手動で残るのはライセンス同意が必要な2つだけ:
> ① Epic LauncherでUE 5.1をインストール ② Audiokinetic LauncherでWwise 2021.1.11+offline統合ファイルをDL。
> スクリプトは何度でも再実行可(済みの工程はスキップ)。
>
> ```powershell
> Set-ExecutionPolicy -Scope Process Bypass
> E:\steam_hosts\pal\mods\PalSmith\tools\setup-pmk.ps1
> ```
